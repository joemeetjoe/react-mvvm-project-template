      ...
      return [
        {
          ...
          templateFile: 'new-feature/entitySchema.ts.hbs',
        },
        {
          type: 'add',
          path: `${entityDir}/${entityCamel}Api.ts`,
          templateFile: 'new-feature/entityApi.ts.hbs',
        },
        {
          type: 'add',
          path: `${entityDir}/${entityCamel}Fixtures.ts`,
          templateFile: 'new-feature/entityFixtures.ts.hbs',
        },
        {
          type: 'add',
          path: `${entityDir}/${entityCamel}Handlers.ts`,
          templateFile: 'new-feature/entityHandlers.ts.hbs',
        },
        {
          type: 'add',
          path: `${entityDir}/${entityCamel}Queries.ts`,
          templateFile: 'new-feature/entityQueries.ts.hbs',
        },
        {
          type: 'add',
          path: `${screenDir}/${entityPascal}ListView.tsx`,
          templateFile: 'new-feature/listView.tsx.hbs',
        },
        {
          type: 'add',
          path: `${screenDir}/use${entityPascal}ListViewModel.ts`,
          templateFile: 'new-feature/listViewModel.ts.hbs',
        },
        {
          type: 'add',
          path: `${screenDir}/index.tsx`,
          templateFile: 'new-feature/screenIndex.tsx.hbs',
        },
        {
          type: 'add',
          path: `${screenDir}/${entityPascal}ListSkeleton.tsx`,
          templateFile: 'new-feature/listSkeleton.tsx.hbs',
        },
        {
          type: 'add',
          path: `${featureDir}/routes/${entityCamel}ListRoute.tsx`,
          templateFile: 'new-feature/listRoute.tsx.hbs',
        },
        {
          type: 'add',
          path: `${featureDir}/__integrations__/${entityCamel}List.test.tsx`,
          templateFile: 'new-feature/integrationTest.test.tsx.hbs',
        },

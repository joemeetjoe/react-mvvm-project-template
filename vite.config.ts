...
export default defineConfig({
  ...
  test: {
    projects: [
      ...
      {
        // The scaffolder acceptance test generates a real feature into the
        // working tree and lints/typechecks it, so it runs on its own
        // (npm run test:scaffolder), outside `npm run test` and `validate`.
        extends: true,
        test: {
          name: 'scaffolder',
          environment: 'node',
